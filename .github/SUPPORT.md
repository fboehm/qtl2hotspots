# Getting help with hotspots

Thanks for using hotspots. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/hotspots/issues) to make sure the 
