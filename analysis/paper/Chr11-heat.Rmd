...
Regarding possible transformations of the rows of the matrix, I don't really like transformations here. Transformations aim to preserve, in some sense, the distribution of values - test statistics, here - and I don't think that we should do that. I don't really care if a given row comes from a normal distribution, for example. I'm inclined to prefer heatmaps of the raw values.
