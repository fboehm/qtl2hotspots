...
mediation analysis to assess the extent which the local trait mediates the QTL effect on the nonlocal trait. Each mediation analysis involved fitting four linear models (Equations \@ref(eq:model1), \@ref(eq:model2), \@ref(eq:model3), \@ref(eq:model4)) [@chick2016defining].
