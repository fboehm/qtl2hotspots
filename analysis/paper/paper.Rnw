...
<<load_attie, eval=!file.exists(here("analysis", "data", "raw_data", "Attie_DO378_eQTL_viewer_v1.Rdata"))>>=
...
plotly::orca(p, here("analysis", "figures", fnsvg))
plotly::orca(p, here("analysis", "figures", fnpdf))
p
@
