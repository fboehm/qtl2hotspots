...
We generated scatter plots of pleiotropy test statistics vs. mediation LOD difference values for each of the five hotspots (Figure~\ref{}, \ref{}).
...
<<ref.label = "index-v-peak-position-2">>=
@
...
<<ref.label = "more_setup-2">>=
@

<<ref.label="readRDS-2">>=
@

<<ref.label="make_local_annot-2">>=
@

<<ref.label = "make_nonlocal_annot-2">>=
@

<<ref.label = "make_local_annot2-2">>=
@

<<ref.label = "subset_expr_matrix-2">>=
@

<<ref.label = "tabulate-2", message=FALSE, warning = FALSE>>=
@

<<ref.label="make_pleio_tib-2">>=
@
