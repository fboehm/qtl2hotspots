...
include_graphics("../figures/Chr2_scatter.pdf")
@

<<fig.cap = "Chr 2 hotspot scatter plots of mediation LOD difference against pleiotropy LOD, separated by local trait.">>=
include_graphics("../figures/Chr2_scatter-panel.pdf")
@
...
<<fig.cap = "Chr 5 hotspot scatter plots of mediation LOD difference against pleiotropy LOD, separated by local trait.">>=
include_graphics("../figures/Chr5_scatter-panel.pdf")
@
...
<<fig.cap = "Chr 7 hotspot scatter plots of mediation LOD difference against pleiotropy LOD, separated by local trait.">>=
include_graphics("../figures/Chr7_scatter-panel.pdf")
@
...
<<fig.cap = "Chr 11 hotspot scatter plots of mediation LOD difference against pleiotropy LOD, separated by local trait.">>=
include_graphics("../figures/Chr11_scatter-panel.pdf")
@
...
<<fig.cap = "Chr 13 hotspot scatter plots of mediation LOD difference against pleiotropy LOD, separated by local trait.">>=
include_graphics("../figures/Chr13_scatter-panel.pdf")
@
