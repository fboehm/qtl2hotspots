...
p <- pleio_mixed_list %>%
  ...
  ggplot() + geom_point(mapping = aes(x = pleiotropy_lod, y = lod_diff, xlab = "Pleiotropy LOD", ylab = "Mediation LOD difference", colour = local_symbol, nonlocal = nonlocal_symbol), size = 0.05) + theme(legend.position = "none")
