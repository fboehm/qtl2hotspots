...
```{r heat9-2, eval = !file.exists(fnhtml)}
...
```{r heat9-5, ref.label = "heat9-2", eval = !file.exists(fnhtml)}
```
...
```{r heat9-7, ref.label = "heat9-2", eval = !file.exists(fnhtml)}
```
...
```{r heat9-11, ref.label = "heat9-2", eval = !file.exists(fnhtml)}
```
...
```{r heat9-13, ref.label = "heat9-2", eval = !file.exists(fnhtml)}
```
