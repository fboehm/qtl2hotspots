...
out <- pmap(tibble(hot_chr, hot_mid, keller_mediator), function(hot_chr, hot_mid, keller_mediator) knitr::knit_expand(text = readLines(here::here("analysis", "paper", "hotspot-one-chromosome.Rmd"))))
```
...
out <- knitr::knit_expand(file = "hotspot-one-chromosome.Rmd")
```
...
out <- knitr::knit_expand(file = here::here("analysis", "paper", "hotspot-one-chromosome.Rmd"))
```
