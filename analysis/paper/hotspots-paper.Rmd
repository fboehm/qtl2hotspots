...
```{r load_attie, eval=!file.exists(here("analysis", "data", "derived_data", "expr.rds"))}
...
ggsave(filename = here("analysis", "figures", fnsvg), height = ceiling(nlocal / 2))
ggsave(filename = here("analysis", "figures", fnpdf), height = ceiling(nlocal / 2))
...
```{r heat9-5, ref.label = "heat9-2"}
```


```{r hm_plot-5, ref.label = "hm_plot-2"}
```
...
```{r heat9-7, ref.label = "heat9-2"}
```


```{r hm_plot-7, ref.label = "hm_plot-2"}
...
```{r heat9-11, ref.label = "heat9-2"}
```


```{r hm_plot-11, ref.label = "hm_plot-2"}
...
```{r heat9-13, ref.label = "heat9-2"}
```


```{r hm_plot-13, ref.label = "hm_plot-2"}
...
```{r fig.cap="Scatter plot of mediation LOD difference against pleiotropy LOD for all nonlocal-local trait pairs mapping to Chromosome 2 hotspot."}
...
```{r panel1, fig.cap = paste0("Chr", hot_chr, "hotspot scatter plots of mediation LOD difference against pleiotropy LOD, separated by local trait.")}
include_graphics(paste0("../figures/Chr", hot_chr, "_scatter-panel1.pdf"))
```


```{r panel2, eval = nfig[which(names(nfig) == paste0("Chr", hot_chr))] > 1}
include_graphics(paste0("../figures/Chr", hot_chr, "_scatter-panel2.pdf"))
```

```{r panel3, eval = nfig[which(names(nfig) == paste0("Chr", hot_chr))] > 2}
...
```{r fig.cap="Scatter plot of mediation LOD difference against pleiotropy LOD for all nonlocal-local trait pairs mapping to Chromosome 5 hotspot."}
#include_graphics("../figures/Chr5_scatter.pdf")
```



```{r ref.label = "panel1", fig.cap = paste0("Chr", hot_chr, "hotspot scatter plots of mediation LOD difference against pleiotropy LOD, separated by local trait.")}
```


```{r ref.label = "panel2", eval = nfig[which(names(nfig) == paste0("Chr", hot_chr))] > 1}
```

```{r ref.label = "panel3", eval = nfig[which(names(nfig) == paste0("Chr", hot_chr))] > 2}
```
...
```{r fig.cap="Scatter plot of mediation LOD difference against pleiotropy LOD for all nonlocal-local trait pairs mapping to Chromosome 7 hotspot."}
...
```{r fig.cap="Scatter plot of mediation LOD difference against pleiotropy LOD for all nonlocal-local trait pairs mapping to Chromosome 11 hotspot."}
...
```{r fig.cap="Scatter plot of mediation LOD difference against pleiotropy LOD for all nonlocal-local trait pairs mapping to Chromosome 13 hotspot."}
