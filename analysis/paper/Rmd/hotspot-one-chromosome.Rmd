...
```{r, scatter_by_local-{{hot_chr}}, fig.height = ceiling(nlocal / 2), fig.cap="Pleiotropy test statistic vs. mediation LOD difference by local expression trait for Chr {{hot_chr}} hotspot."}
